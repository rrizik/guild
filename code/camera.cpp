...
camera_2d_update(Camera2D* camera, f32 aspect_ratio){
    ...
    camera->p0 = make_v2(camera->left_border, camera->top_border);
    camera->p1 = make_v2(camera->right_border, camera->top_border);
    camera->p2 = make_v2(camera->right_border, camera->bottom_border);
    camera->p3 = make_v2(camera->left_border, camera->bottom_border);
}
