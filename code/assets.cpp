...
load_assets(Arena* arena, Assets* assets){
    ...
    Bitmap bm;
    bm = bitmap_file_read(scratch.arena, build_path, str8_literal("sprites/grass1.bmp"));
    d3d_init_texture_resource(&assets->textures[TextureAsset_Grass1].view, &bm);
    bm = bitmap_file_read(scratch.arena, build_path, str8_literal("sprites/grass2.bmp"));
    d3d_init_texture_resource(&assets->textures[TextureAsset_Grass2].view, &bm);
    bm = bitmap_file_read(scratch.arena, build_path, str8_literal("sprites/grass3.bmp"));
    d3d_init_texture_resource(&assets->textures[TextureAsset_Grass3].view, &bm);
    bm = bitmap_file_read(scratch.arena, build_path, str8_literal("sprites/grass4.bmp"));
    d3d_init_texture_resource(&assets->textures[TextureAsset_Grass4].view, &bm);
    bm = bitmap_file_read(scratch.arena, build_path, str8_literal("sprites/grass5.bmp"));
    d3d_init_texture_resource(&assets->textures[TextureAsset_Grass5].view, &bm);
    bm = bitmap_file_read(scratch.arena, build_path, str8_literal("sprites/grass6.bmp"));
    d3d_init_texture_resource(&assets->textures[TextureAsset_Grass6].view, &bm);
    bm = bitmap_file_read(scratch.arena, build_path, str8_literal("sprites/grass7.bmp"));
    d3d_init_texture_resource(&assets->textures[TextureAsset_Grass7].view, &bm);
    bm = bitmap_file_read(scratch.arena, build_path, str8_literal("sprites/grass8.bmp"));
    d3d_init_texture_resource(&assets->textures[TextureAsset_Grass8].view, &bm);
    bm = bitmap_file_read(scratch.arena, build_path, str8_literal("sprites/castle1.bmp"));
